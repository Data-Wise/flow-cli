...
**Status:** Implemented — em v2.0 shipped (v7.5.0 per `README.md` What's New: "em v2.0 safety gate, ICS calendar, IMAP watch, folder CRUD") (verified 2026-07-02 via docs-gap audit, `docs/specs/PLAN-docs-gap-2026-07-02.md`)
**Created:** 2026-02-26
