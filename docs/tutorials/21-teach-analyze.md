...
- [API Reference](../reference/TEACH-ANALYZE-API-REFERENCE.md) — Function documentation
- [Architecture](../reference/TEACH-ANALYZE-ARCHITECTURE.md) — System design with diagrams
- [Quick Reference Card](../reference/REFCARD-TEACH-ANALYZE.md) — One-page cheat sheet
