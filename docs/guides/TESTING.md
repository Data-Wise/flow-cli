...
|--------|-------|
| Test files | 205 |
| Test suites (run-all.sh) | 52/52 passing |
...
54 suites, ~12000 assertions. Expected: 52/52 pass, 2 timeouts (doctor + IMAP connectivity).
...
**Test Count:** 205 test files, 12000+ assertions, 52/52 suites passing
