...
|--------|-------|
| Test files | 196 |
| Test suites (run-all.sh) | 47/47 passing |
...
47 suites, ~12000 assertions. Expected: 47/47 pass, 2 timeouts (IMAP connectivity test).
...
**Test Count:** 196 test files, 12000+ assertions, 47/47 suites passing
