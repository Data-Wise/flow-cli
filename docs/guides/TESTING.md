...
|--------|-------|
| Test files | 198 |
| Test suites (run-all.sh) | 49/49 passing |
| Test functions | 12,000+ |
| Expected timeouts | 2 (doctor + IMAP connectivity) |
...
51 suites, ~12000 assertions. Expected: 49/49 pass, 2 timeouts (doctor + IMAP connectivity).
...
**Test Count:** 198 test files, 12000+ assertions, 49/49 suites passing
