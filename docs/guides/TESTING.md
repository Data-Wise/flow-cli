...
|--------|-------|
| Test files | 197 |
| Test suites (run-all.sh) | 48/48 passing |
...
50 suites, ~12000 assertions. Expected: 48/48 pass, 2 timeouts (doctor + IMAP connectivity).
...
**Test Count:** 197 test files, 12000+ assertions, 48/48 suites passing
