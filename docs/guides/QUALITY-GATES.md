...
Runs core smoke tests in a clean Ubuntu environment with mock project structure. Full test suite (196 files, 12000+ functions) runs locally via `./tests/run-all.sh`.
