...
Runs core smoke tests in a clean Ubuntu environment with mock project structure. Full test suite (179 `test-*.zsh` files, 85 suites, 12000+ functions) runs locally via `./tests/run-all.sh`.
