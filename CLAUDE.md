...
├── tests/                    # 197 test files, 12000+ test functions
...
**197 test files, 12000+ test functions.** Run: `./tests/run-all.sh` (48/48 passing, 2 expected timeouts) or individual suites in `tests/`.
...
**Version:** v7.5.0 | **Tests:** 12000+ (48/48 suite) | **Docs:** https://Data-Wise.github.io/flow-cli/
